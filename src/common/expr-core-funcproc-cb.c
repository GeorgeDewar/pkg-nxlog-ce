			     ...
			     nx_value_t *args)
{
    ...
    retval->string = nx_string_create(nx_value_to_string(&(args[0])), -1);
    retval->defined = TRUE;
}
			   ...
			   nx_value_t *args)
{
	...
	nx_string_append(result, args[2].string->buf, (int) args[2].string->len);
...
void nx_expr_proc__drop(nx_expr_eval_ctx_t *eval_ctx,
			nx_module_t *module UNUSED,
			nx_expr_arg_list_t *args UNUSED)
{
