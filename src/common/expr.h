...
typedef struct nx_expr_arg_t nx_expr_arg_t;
struct nx_expr_arg_t
{ 
    NX_DLIST_ENTRY(nx_expr_arg_t) link;
    nx_expr_t		*expr;
};
typedef struct nx_expr_arg_list_t nx_expr_arg_list_t;
NX_DLIST_HEAD(nx_expr_arg_list_t, nx_expr_arg_t);
